...
const ProjectsOverview: React.FC = () => {
  return (
    <div className="bg-card rounded-xl shadow-lg p-8 border border-border flex flex-col items-center justify-center min-h-[300px]">
      <h3 className="text-2xl font-bold text-card-foreground mb-4">Projects Coming Soon</h3>
